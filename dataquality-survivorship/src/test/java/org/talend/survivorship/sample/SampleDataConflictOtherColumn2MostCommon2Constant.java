...
public class SampleDataConflictOtherColumn2MostCommon2Constant {
    ...
    public static final String PKG_NAME_CONFLICT_FRE_NULL_CONSTANT =
            "org.talend.survivorship.conflict.fre_null_constant"; //$NON-NLS-1$
    ...
    public static final ConflictRuleDefinition[] RULES_CONFLICT_RESOLVE = {
            new ConflictRuleDefinition(new DefFunParameter("firstName", Function.FillEmpty, null, "lastName", null), //$NON-NLS-1$//$NON-NLS-2$
                    Order.SEQ, "fillEmpty_lastName", false, false, 0),
            new ConflictRuleDefinition(
                    new DefFunParameter("lastName", Function.ExcludeValues, "Green|Blue", "lastName", null), //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
                    Order.SEQ, "more_common_lastName", //$NON-NLS-1$
                    false, false, 1),
            new ConflictRuleDefinition(new DefFunParameter("lastName", Function.Longest, null, "lastName", null), //$NON-NLS-1$//$NON-NLS-2$
                    Order.SEQ, "more_common_lastName", false, false, 2) };
