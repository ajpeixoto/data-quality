...
public class SurvivorshipConstants {
    ...
    public static final String RULE_ITEM_EXTENSION = "drl"; //$NON-NLS-1$

    public static final String FLOW_ITEM_EXTENSION = "bpmn"; //$NON-NLS-1$

    public static final String VERSION_SUFFIX = "_0.1."; //$NON-NLS-1$

    public static final String DROOLS = "drools"; //$NON-NLS-1$

    public static final String SURVIVOR_FLOW = "SurvivorFlow"; //$NON-NLS-1$
